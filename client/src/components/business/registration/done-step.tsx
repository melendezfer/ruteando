 ...
 * administrador lo apruebe (Épica 9 backend / F9 frontend).
 */
export function DoneStep({ businessName, businessId }: DoneStepProps) {
  return (
    <div className="flex flex-1 flex-col items-center justify-center gap-4 text-center">
      ...
      <p className="max-w-sm font-sans text-body text-text-muted">
        ...
        cuando un administrador lo revise y quede visible en el mapa y las búsquedas.
      </p>
